...
const Education = ({ onClose }) => {
  ...
  const styles = {
    newspaper: {
      ...
      boxShadow:
        "inset 0 0 25px rgba(0, 0, 0, 0.4), 0 0 25px rgba(0, 0, 0, 0.4)",
        ...
        <div>
          <div style={styles.newspaperSection}>
            <div style={styles.column}>
              <h2 style={styles.sectionTitle}>1337,the 42 network</h2>
              <div>
          ...
          <div style={styles.newspaperSection}>
            <div style={styles.column}>
              <h2 style={styles.sectionTitle}>ISTA</h2>
              <div>
                <p style={styles.sectionSubtitle}>
                  ...
                  <p style={{ textAlign: "left" }}>
                    ...
                    both front-end and back-end technologies, including HTML,
                    CSS, JavaScript, React, PHP, Laravel, MySQL, MongoDB, and
                    REST APIs. During the program, I participated in real-world
                    projects, collaborated in agile teams, and practiced
                    continuous code improvement through version control with
                    Git. The training emphasized UI/UX design, deployment
                    strategies, and professional problem-solving. I also
                    developed skills in algorithms, Python programming, custom
                    Tkinter applications, DevOps, jQuery, Linux, UML, user
                    interface and experience design, and entrepreneurship.
                  </p>
                </p>
              </div>
            </div>
